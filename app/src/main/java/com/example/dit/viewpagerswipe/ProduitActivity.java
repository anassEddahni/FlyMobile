...
public class ProduitActivity extends AppCompatActivity {
    ...
    @BindArray(R.array.nav_item_activity_titles) String[] activityTitles;// toolbar titles respected to selected nav menu item
    View navHeader;
    ImageView imgNavHeaderBg ;
    ImageView imgProfile;
    Toolbar toolbar;
    private static final String urlNavHeaderBg = "https://s7g8.scene7.com/is/image/FLY//linkup?fmt=jpg&wid=781&hei=1068";// urls to load navigation header background imageband profile image
    private static final String urlProfileImg = "https://s7g8.scene7.com/is/image/FLY//logo-myfly";// index to identify current nav menu item
